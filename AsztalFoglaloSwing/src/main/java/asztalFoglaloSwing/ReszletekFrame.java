...
public class ReszletekFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ReszletekFrame
     */
    public ReszletekFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        etteremNev.setText("Sample");

        fogaloNevLabel.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        fogaloNevLabel.setText("Sample Janos");

        jLabel1.setText("2024. 11. 03. 18:30-19:00");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReszletekFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReszletekFrame().setVisible(true);
            }
        });
    }
